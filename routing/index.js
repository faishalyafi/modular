...
const masterPengiriman = require("../module/masterPengiriman/route");
const gudang = require("../module/gudang/route");
const transaksiPO = require("../module/transaksiPO/route");
const transaksiOP = require("../module/transaksiOP/route");
const stock = require("../module/stock/route");
const report = require("../module/report/route");
...
const absensiKaryawan = require("../module/absensiKaryawan/route");
...
router.use('/absensiKaryawan', absensiKaryawan);
